...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid kontent">
      <div class="row">
        <div class="col-md-12">
          <div class="bg-warning border-0 welcome-content shadow-sm">
            <div class="card-body">
              <div class="row">
                <div class="col-md-8">
                  <h1 class="welcome-text">Sugeng Rawuh ing Toko Kita</h1>
                  <small class="text-muted">- versi 1.0-Beta</small>
                  <hr>
                  <p class="">Toko Kita adalah aplikasi kasir untuk toko dan retail apa saja  </p>
                  
                </div>
                <div class="col-md-4">
                    <div class="card text-center border-0 " style="width: 18rem;">
                      <div class="card-body bg-light">
                        <h1 class="display-4 card-title judule">Toko<b> Kita</b> </h1>
                      </div>
                    </div>
                </div>
              </div>
